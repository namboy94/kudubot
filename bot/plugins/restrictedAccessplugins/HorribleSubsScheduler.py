...
"""
plugin that allows scheduling of horriblesubs downloads
...
"""
The HorribleSubsScheduler Class
"""
class HorribleSubsScheduler(GenericPlugin):
    ...
    """
    def regexCheck(self):
        return re.search(r"^/horriblesubs schedule [^ ]+$", self.message)
