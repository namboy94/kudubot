...
class Reminder(GenericPlugin):
    ...
    def get_response(self):
        ...
        """
        file = open(os.getenv("HOME") + "/.whatsbot/reminders/" + str(int(time.time())), 'w')
    ...
    def __find_reminders__(self):
        ...
        """
        reminders = os.listdir(os.getenv("HOME") + "/.whatsbot/reminders")
        reminder_entities = []
        reminder_paths = []
        for reminder in reminders:
            path = os.getenv("HOME") + "/.whatsbot/reminders/" + reminder
